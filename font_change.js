...
let S_WIDTH = 600;
// let S_HEIGTH = window.innerHeight;
let S_HEIGTH = S_WIDTH;
var camera = {
	focus : 400,
	self : {
		x : 0,
...
// let colorBg1 = 'rgba(0,0,0,1)';
// let colorText1 = 'rgba(255,255,255,0.1)';
// let colorBg2 = 'rgba(255,255,255,1)';
// let colorText2 = 'rgba(0,0,0,0.1)';
let colorBg1 = 'rgba(255,160,0,1)';//#FFA000
let colorText1 = 'rgba(255,255,255,0.1)';
// let colorBg2 = 'rgba(255,255,255,1)';
let colorBg2 = 'rgba(50,31,63,1)';//#7B1B09紫色
let colorText2 = 'rgba(255,160,0,0.1)';//#FFA000

var strokeColor = colorText1;
var backgroundColor = colorBg1;
var vibrateFlag = false;

var canvas = document.getElementById("canvas");
var canvasWidth = S_WIDTH;
var canvasHeight = S_HEIGTH;
...
window.onresize = function() {
	...
	canvas.height = S_HEIGTH;
  canvas.style.width = canvasWidth + 'px';
  canvas.style.height = canvasHeight + 'px';
	camera.display.x = S_WIDTH/2;
	camera.display.y = S_HEIGTH/2;
};
...
//文字，尺寸，间距，过场时间，绘制延迟
var textSet = [
	{text:"祝仔仔", sphereRadius:100, sphereSpace:100, unitTime:150, time:3500},
	{text:"生日快乐", sphereRadius:100, sphereSpace:100, unitTime:150, time:3500},
];
...
var start = function() {
	...
	setInterval(function() {
		// console.log(vibrateCV.execution());
		...
		ctx.fillRect(0, 0, S_WIDTH, S_HEIGTH);
		ctx.strokeStyle = strokeColor;
		update();
		draw();
	}, 1000/60);
...
document.body.onmousemove = function(e) {
	camera.rotate.x = e.pageY/S_HEIGTH * 180 - 90;
	camera.rotate.y = e.pageX/S_WIDTH * 180 - 90;
...
function renderGif() {
	...
	gif.addFrame(document.getElementById('start'), {
		delay: 2000,
	})
	setTimeout(()=>{
		for(let i = 0; i < 60; i++){
